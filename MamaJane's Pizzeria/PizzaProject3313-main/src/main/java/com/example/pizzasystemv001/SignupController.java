...
public class SignupController {
    ...
    private String stringUserFirstName;
    private String stringUserLastName;
    private String stringUserPhoneNumber;
    private String stringUserPassword;
    @FXML
    public void registerUser(ActionEvent event) throws IOException {
        UserInformation userInformation = new UserInformation();
        userInformation.setFirstName(userFirstName.getText());
        userInformation.setLastName(userLastName.getText());
        userInformation.setPhoneNumber(userPhoneNumber.getText());
        userInformation.setPassword(userPassword.getText());
        loadLogin(event);
    }
}
